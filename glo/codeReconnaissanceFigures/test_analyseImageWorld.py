...
class TestAnalyseImageWorld(TestCase):
    ...
    def test_retourneBonNombreElement_AvecImageParfaite(self):
        ...
        self.assertEqual(len(self.elementsCartographiques), 17, "Le systeme n'a pas detecte le bon nombre de forme prefaites")
    ...
    def test_retourneBonNombreElement_AvecImageOriginale(self):
        ...
        self.assertEqual(len(self.elementsCartographiques), 17, "Le systeme n'a pas detecte le bon nombre de forme reelles")
