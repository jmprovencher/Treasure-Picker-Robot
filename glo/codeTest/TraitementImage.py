...
class TraitementImage:
    ...
    def findRed(self):
        ...
        shapeRedMask = cv2.inRange(self.image, lower, upper)
        ...
        for c in contoursRouge:
            cv2.drawContours(self.image, [c], -1, (0, 0, 255), 50)
    ...
    def findBlue(self):
        ...
        # Retourne un masque binair (pixel=blanc (255, 255, 255) si elle est
        # dans l'intervalle et noir (0, 0, 0) dans le cas contraire)
        shapeBlueMask = cv2.inRange(self.image, lower, upper)
        ...
        for c in contoursBleu:
            cv2.drawContours(self.image, [c], -1, (255, 0, 0), 50)
    ...
    def findYellow(self):
        ...
        # Retourne un masque binair (pixel=blanc (255, 255, 255) si elle est
        # dans l'intervalle et noir (0, 0, 0) dans le cas contraire)
        shapeYellowMask = cv2.inRange(self.image, lower, upper)
        ...
        for c in contoursJaune:
            cv2.drawContours(self.image, [c], -1, (0, 255, 255), 50)
    ...
    def findGreen(self):
        ...
        # Retourne un masque binair (pixel=blanc (255, 255, 255) si elle est
        # dans l'intervalle et noir (0, 0, 0) dans le cas contraire)
        shapeGreenMask = cv2.inRange(self.image, lower, upper)
        ...
        for c in contoursVert:
            cv2.drawContours(self.image, [c], -1, (0, 255, 0), 50)
