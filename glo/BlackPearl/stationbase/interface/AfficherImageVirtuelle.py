...
class AfficherImageVirtuelle(QThread):
    ...
    def run(self):
        self.attendreStationBase()
        self.interface.threadStationBase.attendreImageVirtuelle()
        while 1:
    ...
    def attendreStationBase(self):
        while self.interface.threadStationBase is None:
            time.sleep(0.01)